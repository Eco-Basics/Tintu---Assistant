...
- [x] `tests/test_prompt_builder.py` — stubs for PERS-01 (prompt assembly order, preferences included, traits placeholder, persona appended)
- [x] `tests/test_preference_echo.py` — stubs for PERS-04 (natural language confirmation format)
